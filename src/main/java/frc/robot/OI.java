...
public class OI {
    ...
    public OI() {
        this.controller = new XboxController(RobotMap.CONTROLLER_PORT);
    }
	...
	public boolean getButtonM1() { return controller.getRawButton(RobotMap.CONTROLLER_BUTTON_M1); }

	public boolean getButtonM2() { return controller.getRawButton(RobotMap.CONTROLLER_BUTTON_M2); }
